...
BEGIN TRAN
-- El primer paso es crear los ajustes para la cantidades que 
-- sabemos podemos eliminar de forma segura, que son aquellas
-- menores a 4 decimales, o donde la cantidad del serie lote 
-- corresponde con la existencia en saldoU.
